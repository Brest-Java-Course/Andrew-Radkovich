...
INSERT INTO TICKET (ticket_id, customer_id, cost, location, data, title, taken) VALUES (7, NULL, 2300, 3, '2014-3-15', 'green mile', FALSE);
INSERT INTO TICKET (ticket_id, customer_id, cost, location, data, title, taken) VALUES (8, NULL, 2300, 2, '2014-3-15', 'Star Wars : New Hope', FALSE);
INSERT INTO TICKET (ticket_id, customer_id, cost, location, data, title, taken) VALUES (9, NULL, 2300, 2, '2014-3-15', 'interstellar', FALSE);